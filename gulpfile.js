...
var paths = {
	...
	src_online: 'src/images-online/**/*',
	src_screen: 'src/images-screen/**/*',
	src_pic: 'src/pic/**/*',
	...
	dist_online: 'dist/images-online',
	dist_screen: 'dist/images-screen',
	dist_pic: 'dist/pic',
	// main_js: "main.js",
...
var handleHtmlAry = [paths.src_html, paths.src_json, paths.src_php, paths.src_txt, paths.src_mp3];
// HTML处理
...
gulp.task('images', function() {
	gulp.src(paths.src_online)
    .pipe(gulp.dest(paths.dist_online));

    gulp.src(paths.src_screen)
    .pipe(gulp.dest(paths.dist_screen));
